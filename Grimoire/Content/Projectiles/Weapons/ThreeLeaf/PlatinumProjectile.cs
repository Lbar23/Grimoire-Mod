...
{
    internal class PlatinumProjectile : ModProjectile
    {
        public override void SetDefaults()
        {
            ...
            Projectile.penetrate = 3;  // penetrates 2 enemy
        ...
        public override void AI()
        {
            ...
            dust = Terraria.Dust.NewDustPerfect(position, 76, new Vector2(0f, 0f), 0, new Color(255, 255, 255), 2.1511629f);
            dust.noGravity = true;
        }
